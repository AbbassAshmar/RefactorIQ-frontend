    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          {/* Code */}
          <Route
            path="/dashboard/code/repo-explorer"
            element={<RepoExplorer />}
          />

          {/* Architecture */}
          <Route
            path="/dashboard/architecture/dependencies"
          ...
          <Route
            path="/dashboard/scans/dashboard"
            element={<ScansDashboard />}
          />

          {/* Refactoring */}
          <Route
            path="/dashboard/refactoring/queue"
            element={<RefactorQueue />}
          />
          <Route
            path="/dashboard/refactoring/suggestions"
            element={<RefactorSuggestions />}
          />

          {/* History */}
          <Route
            path="/dashboard/history/commits"
            element={<CommitHistory />}
          />
          <Route
            path="/dashboard/history/file-evolution"
            element={<FileEvolution />}
          />
        ...
        >
          ...
          {/* Scans */}
          <Route
            path="/admin/scans/overview"
            element={<AdminScansOverview />}
          />
