...
export const LIGHT_THEME = {
  ...
  'chart-scans-duration': 'hsl(178, 34%, 39%)',
  'chart-scans-duration-fill': 'hsla(178, 34%, 39%, 0.14)',
  'chart-scans-files-analyzed': 'hsl(220, 32%, 45%)',
  'chart-scans-files-analyzed-fill': 'hsla(220, 32%, 45%, 0.14)',
  'chart-scans-priority-critical': 'hsl(3, 58%, 54%)',
  'chart-scans-priority-high': 'hsl(33, 72%, 48%)',
  'chart-scans-priority-medium': 'hsl(201, 44%, 46%)',
  'chart-scans-priority-low': 'hsl(147, 38%, 42%)',
