...
export const DARK_THEME = {
  ...
  'chart-scans-duration': 'hsl(178, 34%, 51%)',
  'chart-scans-duration-fill': 'hsla(178, 34%, 51%, 0.16)',
  'chart-scans-files-analyzed': 'hsl(220, 32%, 54%)',
  'chart-scans-files-analyzed-fill': 'hsla(220, 32%, 54%, 0.16)',
  'chart-scans-priority-critical': 'hsl(3, 58%, 62%)',
  'chart-scans-priority-high': 'hsl(33, 72%, 60%)',
  'chart-scans-priority-medium': 'hsl(201, 44%, 58%)',
  'chart-scans-priority-low': 'hsl(147, 38%, 54%)',
  ...
  'chart-top-architectures-bar-2': 'hsl(200, 30%, 50%)',
  'chart-top-architectures-bar-3': 'hsl(175, 28%, 47%)',
  'chart-top-architectures-bar-4': 'hsl(150, 27%, 44%)',
