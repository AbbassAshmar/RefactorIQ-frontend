...
export default function NoScanSelectedState({ hasSuccessfulScans, onSelectScan, onGoToScans }) {
    return (
        <section className="flex min-h-[24rem] flex-col items-center justify-center rounded-md border border-border bg-background-secondary px-6 py-10 text-center">
            ...
            <button
                ...
                className="mt-6 inline-flex items-center gap-2 rounded-md bg-brand-primary px-4 py-2 text-body font-semibold text-brand-text transition-colors hover:bg-brand-hover"
            >
                <ScanSearch size={16} />
